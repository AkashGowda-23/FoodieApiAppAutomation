...
public class GetRestaurantByLoction {
	@Test
public void getrestaurantbyloc() {
        ...
        Response resp = request.when().queryParam("location","hydrabad") 
                .log().all().get("/searchByLocation").then().spec(res).extract().response();
